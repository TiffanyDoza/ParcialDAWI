...
<body> 
 ...
 <h1>Crud de Editorial</h1>
  	 ...
  	 <div class="modal fade" id="idEditorialRegistra" >
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_direccion" name="Direccion" placeholder="Ingrese la direccion" />
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_telefono" name="Telefono" placeholder="Ingrese el telefono" type="number"/>
		                                        </div>
		                                    </div>		
		 ...
		 <div class="modal fade" id="idEditorialActualiza" >
			<div class="modal-dialog" style="width: 60%">
		...
		<div class="modal fade" id="idEditorialElimina" >
					<div class="modal-dialog" style="width: 60%">
...
function eliminar(id){	
	$('#idEditorialElimina').modal('show');
	$('#id_elimina').val(id);	
}

function registrar(){	
	$('#idEditorialRegistra').modal("show");
}
...
function editar(id,nombre,direccion,telefono,correo,idPais){	
	...
	$('#idEditorialActualiza').modal("show");
}
        ...
        fields: {
            ...
            "correo": {
                ...
                validators: {
                    ...
                    emailAddress: {
                        message: 'El correo no esta correcto'
                    }
                }
            },
          "pais.idPais": {
